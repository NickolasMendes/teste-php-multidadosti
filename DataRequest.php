...
if (isset($_GET['action']) && $_GET['action'] == 'client') {
    echo (new DataRequest())->dadosClientes();
} 
else if (isset($_GET['action']) && $_GET['action'] == 'supplier') {
    echo (new DataRequest())->dadosFornecedores();
} 
else if (isset($_GET['action']) && $_GET['action'] == 'user') {
    echo (new DataRequest())->dadosUsuarios();
} 
...
class DataRequest {
     ...
     * @return array||String
     */
    public function dadosClientesCount($param = '') {
        if($param === 'c') {
    ...
    public function dadosClientes() {
        $response = ['clientes' => $this->DadosClientes];
     ...
     * @return array||String
     */
    public function dadosFornecedoresCount($param = '') {
        if($param === 'c') {
    ...
    public function dadosFornecedores() {
        $response = ['fornecedores' => $this->DadosFornecedores];
     ...
     * @return array||String
     */
    public function dadosUsuariosCount($param = '') {
        if($param === 'c') {
    ...
    public function dadosUsuarios() {
        $response = ['usuarios' => $this->DadosUsuarios];
